...
description: "Controlled experiment testing fines versus subsidies on household waste generation over 10 days, confirming loss aversion: the fine (loss frame) produced a 28% reduction versus 8% for an equivalent subsidy, consistent with Prospect Theory predictions."
pubDate: "2025-01-01"
...
Participants recorded household waste daily for **10 days**. Pre- and post-study surveys assessed baseline waste management habits and environmental awareness. Real financial stakes were used, with no deception, ensuring the incentive salience necessary to trigger genuine behavioral response. The pilot comprised 10 participants per group (N = 30); a full production study requires 30 per group to achieve adequate statistical power.
