...
tags: ["Artificial Intelligence", "Procurement", "Supply Chain Management", "Survey Research", "Industry 5.0"]
badge: "In Progress"
---
...
1. **How much** of the procurement work does AI actually touch? *(extent)*
2. **Where** does it sit — spend analysis, supplier selection, negotiation, contracts? *(locus)*
3. **How deep** does it go — does AI advise while a person decides, or does it decide on its own? *(depth)*
...
- **Next milestones:** finalising the conceptual model and hypotheses, drafting the survey instrument, and targeting an academic conference submission in late 2026.
